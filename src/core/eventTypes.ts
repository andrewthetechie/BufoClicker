...
// Prestige events
export const PRESTIGE_TRANSCENDED = 'PRESTIGE_TRANSCENDED';

// Golden Bufo (random event) events
export const GOLDEN_BUFO_SPAWNED = 'GOLDEN_BUFO_SPAWNED';
export const GOLDEN_BUFO_EXPIRED = 'GOLDEN_BUFO_EXPIRED';
export const GOLDEN_BUFO_COLLECTED = 'GOLDEN_BUFO_COLLECTED';

// Clicker Boss events
export const BOSS_AVAILABLE = 'BOSS_AVAILABLE';
export const BOSS_FIGHT_STARTED = 'BOSS_FIGHT_STARTED';
export const BOSS_DAMAGED = 'BOSS_DAMAGED';
export const BOSS_TICK = 'BOSS_TICK';
export const BOSS_DEFEATED = 'BOSS_DEFEATED';
export const BOSS_FIGHT_LOST = 'BOSS_FIGHT_LOST';
export const BOSS_FIGHT_RETREATED = 'BOSS_FIGHT_RETREATED';
